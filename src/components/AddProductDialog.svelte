    ...
    <div class="sub-section">
      ...
      <div class="info-grid">
        ...
        <div class="info-field" style="grid-column:1/-1">
          <label>类型</label>
          <label style="display:flex;align-items:center;gap:10px;height:38px;padding:0 10px;font-size:13px;border:1.5px solid var(--c-border);border-radius:9px;background:var(--c-surface)">
