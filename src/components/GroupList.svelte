<script lang="ts">
  import {
    app, currentProduct, currentGroups, calcSampling, addGroup, addStandardGroups,
  ...
  <div style="margin-top:10px">
    ...
    {#if bulkTotalOpen}
      <div style="display:flex;gap:10px;margin-top:8px">
        <input bind:value={bulkTotalInput} type="text" inputmode="numeric" placeholder="批量设置所有组总数量…" maxlength="9"
